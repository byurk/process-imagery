...
def segment(image_path, spatial_radius = 6 , spectral_range_radius = 4.5, min_density =  50, do_computation = True):
    ...
    out_path = ("/".join(image_path.split("/")[:-1]) + "/" + 
                ...
                str(int(spatial_radius)) + "_RR" + str(float(spectral_range_radius)) + "_MD" + 
